...
<head>
   ...
   <link rel="stylesheet" href="<?php echo e(url('css/home_page.css')); ?>">
        <script src="<?php echo e(url('js/home_page.js')); ?>" defer></script>
        <script src="<?php echo e(url('js/navbar.js')); ?>" defer></script>
...
<div id="mySidebar" class="sidebar">
  ...
  <a href="<?php echo e(url('loginPage')); ?>">Login</a>
  <a href="<?php echo e(url('registrazione')); ?>">Signup</a>
                ...
                <div class="c-inner">
                    <div class="c-item active">
                        <div class="c-caption ">
                            ...
                            <button id="showpost" class=" btn btn-primary btn-rounded" href="<?php echo e(url('osservaPost')); ?>">Leggi i post</button>
    ...
    <section class="section" id="testmonial">
            ...
            <div id="owl-testmonial" class="owl-carousel owl-theme mt-4">
                <div class="item">
                    <div class="textmonial-item">
                        <img src="<?php echo e(url('imgs/avatar1.jpeg')); ?>" class="avatar" >
                        <div >
     ...
     <article id="background">
            ...
            <div class="withpost hidden">
                <form name="mypost" id="mypost" method="POST" action="<?php echo e(route('inviopost')); ?>">
                   <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\blog\resources\views/homePage.blade.php ENDPATH**/ ?>